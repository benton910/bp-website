  ...
  return (
    <div className="w-full py-10">
      <div className="relative flex flex-col px-10 mx-auto space-y-5 md:w-full">
        <div className="flex flex-col items-center justify-center p-10 mx-auto mb-10 md:w-3/5 z-10 bg-slate-100/70 rounded-lg">
          <h1 className="text-5xl font-extrabold text-center">
            <span className="block text-blue-600">About Benton Parker</span>
          </h1>
        </div>
        <div className="flex flex-col items-center justify-center mx-auto w-full z-10 bg-slate-400/70 rounded-sm">
          <h3 className="text-2xl font-extrabold m-16 px-5 py-4 text-center text-blue-600 bg-black/70 rounded-md">
          ...
          <div className="flex flex-row items-center justify-center mx-auto mt-10 md:w-full z-10">
            <div className="flex flex-col p-5 items-center justify-center mx-auto z-10">
              <p className="pt-3 pb-3 pl-5 pr-5 text-center text-gray-800">
                With a dedication to his craft and a passion for connecting with audiences, Benton Parker continues to make waves in the Blues/Soul music scene. His commitment to bringing real emotion to every performance and his ability to blend traditional blues with contemporary elements make him a standout artist to watch.
              </p>
              <p className="pt-3 pb-3 pl-5 pr-5 text-center text-gray-800">
                For more information about Benton Parker, upcoming shows, and new releases, stay tuned to this website and follow Benton on social media!
              </p>
            </div>
          </div>
        </div>
